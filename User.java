...
public class User {
    private int id;
    private String email,roles,password,full_name,phone_number,date_of_birth;
    ...
    public User(int id, String email, String password, String roles, String full_name, String phone_number, String date_of_birth) {
        this.id = id;
        this.email = email;
        this.roles = roles;
        this.password = password;
